    ...
    <script>
        function screenLoad(){
            if(screen.width<=768){
                ...
                document.write('<script src="../zjtrain/js/m/calc.min.js?v=201911091550"><\/script>');
            }else{
                ...
                document.write('<script src="../zjtrain/js/pc/calcPopWrap.min.js?v=201911091550"><\/script>');
            }
        }
        screenLoad()
    </script>
