    ...
    <div id="calculation" class="subject-main">
        ...
        <div class="chang-service service-change j-common-form pc-from">
            ...
            <div class="success tc form-success j-form-success">
                <em class="xx-iconfont icon-icon-1 form-close"  @click="successClose"></em>
                ...
                <div class="j-form-footer form-success-footer">
                    <div class="xx-button xx-button-primary xx-button-lg">
                        <div class="timer">
                            03s
                        </div>
                    </div>
    ...
    <script>
        function screenLoad(){
            if(screen.width<=768){
                ...
                document.write('<script src="../zjtrain/js/m/commonForm.min.js?v=201911091550"><\/script>');
                document.write('<script src="../zjtrain/js/m/mStayTest.min.js?v=201911091550"><\/script>');
            }else{
                document.write('<script src="../zjtrain/js/pc/guiji.min.js"><\/script>');
                document.write('<script src="../zjtrain/js/pc/commonForm.min.js?v=201911091550"><\/script>');
                document.write('<script src="../zjtrain/js/pc/stayTest.min.js?v=201911091550"><\/script>');
            }
        }
        screenLoad()
    </script>
